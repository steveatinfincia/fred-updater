...
ARCH=`python -c "import sys; arch = lambda(is_64bit): "64" if is_64bit else "32"; print arch(sys.maxsize > 2**32)"`
...
virtualenv -p python installer_env
...
virtualenv -p python client_env
